      ...
      * PURPOSE  : READ CUSTOMER MASTER RECORDS BY PRIMARY KEY.        *
      * INTERFACE: CALL 'CUSTDAO' USING CSTDAO-AREA CUSTOMER-RECORD    *
      ...
      *================================================================*
       ...
       01  CUSTOMER-MASTER-RECORD           PIC X(100).
       ...
       01  WS-FILE-CUSTOMER.
           COPY CUSTREC REPLACING ==:TAG:== BY ==FIL==.

       LINKAGE SECTION.
       01  LK-DAO-CONTROL.
           COPY CSTDAO REPLACING ==:TAG:== BY ==LKD==.
       01  LK-CUSTOMER.
           COPY CUSTREC REPLACING ==:TAG:== BY ==LKC==.
      ...
      *    FAIL-SAFE INTEGRITY CHECK (EQUIVALENT TO DB2 CONSTRAINTS).
       2100-RETURN-LOCATED-CUSTOMER.
           EVALUATE TRUE
               ...
               WHEN FIL-DOCUMENT IS NOT NUMERIC
